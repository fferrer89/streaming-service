          ...
          <div className="flex flex-col gap-8 py-10 px-6 w-full h-full sm:ml-60">
            ...
            <div className="flex flex-col md:flex-wrap md:flex-row gap-2 w-full">
              <CountWrapper>
                ...
                <div className="flex flex-col pl-8 sm:pl-3">
                  ...
                  <span className="text-xl text-center text-white font-semibold">
                    {data.getUserCount}
                  </span>
                </div>
              </CountWrapper>
              ...
              <CountWrapper>
                ...
                <div className="flex flex-col pl-8 sm:pl-3">
                  <span className="text-sm text-[#B29B80]">
                    Total Playlists
                  </span>
                  <span className="text-xl text-center text-white font-semibold">
                    {data.getPlaylistCount}
                  </span>
                </div>
              </CountWrapper>
            </div>
            <div className="h-80 bg-[#22333B] rounded-sm p-4">
              <span className="text-lg text-[#C6AC8E] font-bold">
            ...
            <div className="flex flex-col items-center sm:flex-row sm:gap-x-4 gap-y-4 justify-evenly">
              <div className="flex flex-col p-4 w-[22rem] h-[22rem] rounded-sm bg-[#22333B]">
                <span className="text-lg pt-4 mb-2 text-[#C6AC8E] font-bold text-center">
              ...
              <div className="flex flex-col p-4 w-[22rem] h-[22rem] rounded-sm bg-[#22333B]">
                <span className="text-lg pt-4 mb-2 text-[#C6AC8E] font-bold text-center">
                  Gender Distribution Among Artist
                </span>
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart width={400} height={400}>
                    <Pie
            ...
            <div className="bg-[#22333B] px-4 pt-4 pb-4 rounded-sm flex-1">
              ...
              <div className="mt-3">
                <table className="w-full text-[#C6AC8E] text-center">
                  ...
                  <tbody>
                    {data.mostLikedSongs.map(
                      (song: MostLikedSongs, index: number) => (
                        <tr
                          key={song._id}
                          className="border-b border-[#38474F]"
                        >
...
const CountWrapper: React.FC<CountWrapperProps> = ({ children }) => {
  return (
    <div className="flex flex-1 items-center min-w-48 py-3 pl-8 sm:pl-4 rounded-sm bg-[#22333B]">
      {children}
    </div>
  );
};
