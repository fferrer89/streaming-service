      ...
      <main className="flex flex-col justify-center items-center py-10 text-black">
        <div className="py-10 px-10 rounded-lg w-full sm:max-w-md bg-white sm:shadow-2xl">
          ...
          <div className="text-xl font-bold mt-4">
            Join today and dive into the world of music
            <p className="inline ml-2 text-3xl font-bold animate-pulse text-red-500 rotate-12">
              &#9835;
            </p>
          </div>
            ...
            >
              <div className="flex flex-col mb-4">
                ...
                <input
                  ...
                  className="px-2 py-2 rounded-md border-2 border-black text-black"
                  {...register("firstName", {
