...
const Signup: React.FC = () => {
  ...
  if (
    loggedIn &&
    (userType === "admin" || userType === "user" || userType === "artist")
  ) {
    return (
            ...
            >
              <div className="flex flex-col mb-4">
                ...
                <input
                  ...
                  className={`p-2 rounded-md border-2 text-black focus:outline-none focus:ring-0 ${
                    errors?.firstName
                      ? "border-red-500 focus:border-red-500"
                      : "border-[#C6AC8E] focus:border-[#A2825D]"
                  }`}
                  {...register("firstName", {
              ...
              <div className="flex flex-col">
                ...
                <select
                  id="role"
                  defaultValue=""
                  className={`px-2 py-3 rounded-md border-2 text-black focus:outline-none focus:ring-0 ${
                    errors?.role
                      ? "border-red-500 focus:border-red-500"
                      : "border-[#C6AC8E] focus:border-[#A2825D]"
                  }`}
